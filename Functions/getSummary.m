...
A_sagittal.Thorax.Summary.Left_sd = sdt(A_sagittal.Thorax.left,0,2);
...
A_frontal.Thorax.Summary.Left_sd = sdt(A_frontal.Thorax.left,0,2);
...
A_transverse.Thorax.Summary.Left_sd = sdt(A_transverse.Thorax.left,0,2);
...
A_sagittal.Thorax.Summary.Right_sd = sdt(A_sagittal.Thorax.right,0,2);
...
A_frontal.Thorax.Summary.Right_sd = sdt(A_frontal.Thorax.right,0,2);
...
A_transverse.Thorax.Summary.Right_sd = sdt(A_transverse.Thorax.right,0,2);
...
A_sagittal.Thorax.Summary.Global_sd = sdt([A_sagittal.Thorax.left,A_sagittal.Thorax.right],0,2);
...
A_frontal.Thorax.Summary.Global_sd = sdt([A_frontal.Thorax.left,A_frontal.Thorax.right],0,2);
...
A_transverse.Thorax.Summary.Global_sd = sdt([A_transverse.Thorax.left,A_transverse.Thorax.right],0,2);
...
A_sagittal.Pelvis.Summary.Left_sd = sdt(A_sagittal.Pelvis.left,0,2);
...
A_frontal.Pelvis.Summary.Left_sd = sdt(A_frontal.Pelvis.left,0,2);
...
A_transverse.Pelvis.Summary.Left_sd = sdt(A_transverse.Pelvis.left,0,2);
...
A_sagittal.Pelvis.Summary.Right_sd = sdt(A_sagittal.Pelvis.right,0,2);
...
A_frontal.Pelvis.Summary.Right_sd = sdt(A_frontal.Pelvis.right,0,2);
...
A_transverse.Pelvis.Summary.Right_sd = sdt(A_transverse.Pelvis.right,0,2);
...
A_sagittal.Pelvis.Summary.Global_sd = sdt([A_sagittal.Pelvis.left,A_sagittal.Pelvis.right],0,2);
...
A_frontal.Pelvis.Summary.Global_sd = sdt([A_frontal.Pelvis.left,A_frontal.Pelvis.right],0,2);
...
A_transverse.Pelvis.Summary.Global_sd = sdt([A_transverse.Pelvis.left,A_transverse.Pelvis.right],0,2);
...
A_sagittal.Hip.Summary.Left_sd = sdt(A_sagittal.Hip.left,0,2);
...
A_frontal.Hip.Summary.Left_sd = sdt(A_frontal.Hip.left,0,2);
...
A_transverse.Hip.Summary.Left_sd = sdt(A_transverse.Hip.left,0,2);
...
A_sagittal.Hip.Summary.Right_sd = sdt(A_sagittal.Hip.right,0,2);
...
A_frontal.Hip.Summary.Right_sd = sdt(A_frontal.Hip.right,0,2);
...
A_transverse.Hip.Summary.Right_sd = sdt(A_transverse.Hip.right,0,2);
...
A_sagittal.Hip.Summary.Global_sd = sdt([A_sagittal.Hip.left,A_sagittal.Hip.right],0,2);
...
A_frontal.Hip.Summary.Global_sd = sdt([A_frontal.Hip.left,A_frontal.Hip.right],0,2);
...
A_transverse.Hip.Summary.Global_sd = sdt([A_transverse.Hip.left,A_transverse.Hip.right],0,2);
...
A_sagittal.Knee.Summary.Left_sd = sdt(A_sagittal.Knee.left,0,2);
...
A_frontal.Knee.Summary.Left_sd = sdt(A_frontal.Knee.left,0,2);
...
A_transverse.Knee.Summary.Left_sd = sdt(A_transverse.Knee.left,0,2);
...
A_sagittal.Knee.Summary.Right_sd = sdt(A_sagittal.Knee.right,0,2);
...
A_frontal.Knee.Summary.Right_sd = sdt(A_frontal.Knee.right,0,2);
...
A_transverse.Knee.Summary.Right_sd = sdt(A_transverse.Knee.right,0,2);
...
A_sagittal.Knee.Summary.Global_sd = sdt([A_sagittal.Knee.left,A_sagittal.Knee.right],0,2);
...
A_frontal.Knee.Summary.Global_sd = sdt([A_frontal.Knee.left,A_frontal.Knee.right],0,2);
...
A_transverse.Knee.Summary.Global_sd = sdt([A_transverse.Knee.left,A_transverse.Knee.right],0,2);
...
A_sagittal.Ankle.Summary.Left_sd = sdt(A_sagittal.Ankle.left,0,2);
...
A_frontal.Ankle.Summary.Left_sd = sdt(A_frontal.Ankle.left,0,2);
...
A_transverse.Ankle.Summary.Left_sd = sdt(A_transverse.Ankle.left,0,2);
...
A_sagittal.Ankle.Summary.Right_sd = sdt(A_sagittal.Ankle.right,0,2);
...
A_frontal.Ankle.Summary.Right_sd = sdt(A_frontal.Ankle.right,0,2);
...
A_transverse.Ankle.Summary.Right_sd = sdt(A_transverse.Ankle.right,0,2);
...
A_sagittal.Ankle.Summary.Global_sd = sdt([A_sagittal.Ankle.left,A_sagittal.Ankle.right],0,2);
...
A_frontal.Ankle.Summary.Global_sd = sdt([A_frontal.Ankle.left,A_frontal.Ankle.right],0,2);
...
A_transverse.Ankle.Summary.Global_sd = sdt([A_transverse.Ankle.left,A_transverse.Ankle.right],0,2);
...
A_sagittal.Foot.Summary.Left_sd = sdt(A_sagittal.Foot.left,0,2);
...
A_frontal.Foot.Summary.Left_sd = sdt(A_frontal.Foot.left,0,2);
...
A_transverse.Foot.Summary.Left_sd = sdt(A_transverse.Foot.left,0,2);
...
A_sagittal.Foot.Summary.Right_sd = sdt(A_sagittal.Foot.right,0,2);
...
A_frontal.Foot.Summary.Right_sd = sdt(A_frontal.Foot.right,0,2);
...
A_transverse.Foot.Summary.Right_sd = sdt(A_transverse.Foot.right,0,2);
...
A_sagittal.Foot.Summary.Global_sd = sdt([A_sagittal.Foot.left,A_sagittal.Foot.right],0,2);
...
A_frontal.Foot.Summary.Global_sd = sdt([A_frontal.Foot.left,A_frontal.Foot.right],0,2);
...
A_transverse.Foot.Summary.Global_sd = sdt([A_transverse.Foot.left,A_transverse.Foot.right],0,2);
...
M_sagittal.Hip.Summary.Left_sd = sdt(M_sagittal.Hip.left,0,2);
...
M_frontal.Hip.Summary.Left_sd = sdt(M_frontal.Hip.left,0,2);
...
M_transverse.Hip.Summary.Left_sd = sdt(M_transverse.Hip.left,0,2);
...
M_sagittal.Hip.Summary.Right_sd = sdt(M_sagittal.Hip.right,0,2);
...
M_frontal.Hip.Summary.Right_sd = sdt(M_frontal.Hip.right,0,2);
...
M_transverse.Hip.Summary.Right_sd = sdt(M_transverse.Hip.right,0,2);
...
M_sagittal.Hip.Summary.Global_sd = sdt([M_sagittal.Hip.left,M_sagittal.Hip.right],0,2);
...
M_frontal.Hip.Summary.Global_sd = sdt([M_frontal.Hip.left,M_frontal.Hip.right],0,2);
...
M_transverse.Hip.Summary.Global_sd = sdt([M_transverse.Hip.left,M_transverse.Hip.right],0,2);
...
M_sagittal.Knee.Summary.Left_sd = sdt(M_sagittal.Knee.left,0,2);
...
M_frontal.Knee.Summary.Left_sd = sdt(M_frontal.Knee.left,0,2);
...
M_transverse.Knee.Summary.Left_sd = sdt(M_transverse.Knee.left,0,2);
...
M_sagittal.Knee.Summary.Right_sd = sdt(M_sagittal.Knee.right,0,2);
...
M_frontal.Knee.Summary.Right_sd = sdt(M_frontal.Knee.right,0,2);
...
M_transverse.Knee.Summary.Right_sd = sdt(M_transverse.Knee.right,0,2);
...
M_sagittal.Knee.Summary.Global_sd = sdt([M_sagittal.Knee.left,M_sagittal.Knee.right],0,2);
...
M_frontal.Knee.Summary.Global_sd = sdt([M_frontal.Knee.left,M_frontal.Knee.right],0,2);
...
M_transverse.Knee.Summary.Global_sd = sdt([M_transverse.Knee.left,M_transverse.Knee.right],0,2);
...
M_sagittal.Ankle.Summary.Left_sd = sdt(M_sagittal.Ankle.left,0,2);
...
M_frontal.Ankle.Summary.Left_sd = sdt(M_frontal.Ankle.left,0,2);
...
M_transverse.Ankle.Summary.Left_sd = sdt(M_transverse.Ankle.left,0,2);
...
M_sagittal.Ankle.Summary.Right_sd = sdt(M_sagittal.Ankle.right,0,2);
...
M_frontal.Ankle.Summary.Right_sd = sdt(M_frontal.Ankle.right,0,2);
...
M_transverse.Ankle.Summary.Right_sd = sdt(M_transverse.Ankle.right,0,2);
...
M_sagittal.Ankle.Summary.Global_sd = sdt([M_sagittal.Ankle.left,M_sagittal.Ankle.right],0,2);
...
M_frontal.Ankle.Summary.Global_sd = sdt([M_frontal.Ankle.left,M_frontal.Ankle.right],0,2);
...
M_transverse.Ankle.Summary.Global_sd = sdt([M_transverse.Ankle.left,M_transverse.Ankle.right],0,2);
...
Power.Hip.Summary.Left_sd = sdt(Power.Hip.left,0,2);
...
Power.Hip.Summary.Right_sd = sdt(Power.Hip.right,0,2);
...
Power.Hip.Summary.Global_sd = sdt([Power.Hip.left,Power.Hip.right],0,2);
...
Power.Knee.Summary.Left_sd = sdt(Power.Knee.left,0,2);
...
Power.Knee.Summary.Right_sd = sdt(Power.Knee.right,0,2);
...
Power.Knee.Summary.Global_sd = sdt([Power.Knee.left,Power.Knee.right],0,2);
...
Power.Ankle.Summary.Left_sd = sdt(Power.Ankle.left,0,2);
...
Power.Ankle.Summary.Right_sd = sdt(Power.Ankle.right,0,2);
...
Power.Ankle.Summary.Global_sd = sdt([Power.Ankle.left,Power.Ankle.right],0,2);
